error id: file:///C:/Users/morgan.graves/Documents/Scala%20Project%201%20-%20Ledger/src/test/scala/ledger/domain/CategorySpec.scala:
...
class CategorySpec extends AnyWordSpec with Matchers {
  ...
  "Category" should {
    ...
    "Group income transactions by category" in {
      ...
      val categories = transactions.groupBy(_.va@@lue).map {
        case (desc, txns) =>
